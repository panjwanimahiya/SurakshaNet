    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-secondary/30 px-4 py-12">
      <div className="w-full max-w-xl">
        <div className="text-center mb-10 select-none">
          ...
          <h1 className="text-2xl lg:text-3xl font-display font-extrabold text-foreground mb-2">Create Your Account</h1>
          <p className="text-muted-foreground text-base">Join SurakshaNet and stay protected</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-card border-2 rounded-2xl p-6 md:p-8 shadow-[var(--shadow-elevated)] space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input id="name" placeholder="Your name" value={name} onChange={(e) => setName(e.target.value)} required className="h-11 text-base" />
          </div>
          <div className="space-y-2">
          ...
          <Button type="submit" className="w-full h-11 text-base font-bold mt-8 shadow-lg shadow-primary/20">Sign Up</Button>
